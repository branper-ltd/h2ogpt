...
cat << EOF > ./source-profile
# export MINICINDA3_INSTALLATION_PATH=$MINICINDA3_INSTALLATION_PATH
# export NLTK_DATA=$NLTK_DATA_PATH
...
wget -O "001-Miniconda3-py310_23.1.0-1-Linux-x86_64.sh" "https://repo.anaconda.com/miniconda/Miniconda3-py310_23.1.0-1-Linux-x86_64.sh"


echo "Miniconda3 instalation path use it for the installation path when asked"
echo $MINICINDA3_INSTALLATION_PATH

bash ./001-Miniconda3-py310_23.1.0-1-Linux-x86_64.sh -u
...
conda remove --name h2ogpt.env --all
...
# Cuda Download Installer for Linux Ubuntu 22.04 x86_64 dev
